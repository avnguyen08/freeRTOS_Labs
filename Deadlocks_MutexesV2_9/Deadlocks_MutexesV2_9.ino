 ...
 * License: 0BSD
 *
 *My Solution to prevent deadlock (Alternate): Make mutex that lets one eater eat at a time
 *
 *
 */
...
static SemaphoreHandle_t mutex;     //Waits for single eater pick up two chopsticks
