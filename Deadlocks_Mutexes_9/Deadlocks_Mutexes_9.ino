 ...
 * License: 0BSD
 *
 *My Solution to prevent deadlock: Make mutexes have a priority into which one gets taken first. (Lowest number gets picked first)
 *
 *
 */
...
void eat(void *parameters) {
  ...
  //if num+1 cycles back to zero, it is the greatest priority
  if(num + 1 == NUM_TASKS){
